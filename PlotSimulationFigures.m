...
% NOTES: 
% 1) You need to have downloaded the 'SyntheticBodyImages.mat' file
% and placed this within the 'Data' directory. 
% 2) Some of this script could take a while to run. If the masks are not
% available for the settings requested, the script will try to generate new 
% masks.  I recommend lowering Mask_N to 50 and N_Repeats to 10 if you have
% limited computing power. 
% 3) If genCSmasks not running, go to 'Required
...
settings.calib = 4; % calibration region
settings.niters_array = 2:1:50; % TxLR iterations
settings.NRepeats = 50; % Repeat with random channel-wise complex Gaussian noise and different undersampling masks (50 repeats used in paper, but requires minimum 500 masks be generated)
