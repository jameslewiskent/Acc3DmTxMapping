function plotfigure2(Maps,Maps_acc,sz,accelerations,Shim_Setting1,type)
cmin = 0; cmax = 150;
...
if strcmp(type,'long')
    fig = figure('color','w','Units','centimeters','Position',[10.710333333333333,-6.731,8.614833333333335,25.5905]); tiledlayout(4,1,'Padding','none','TileSpacing','compact'); 
else
    fig = figure('color','w','Units','centimeters','Position',[0,0,19.57916666666667,15.425208333333334]); tiledlayout(2,2,'Padding','none','TileSpacing','compact'); 
end
ax1 = nexttile;
...
boxplot(boxplotgroup,'Positions',accelerations,'Labels',split(num2str(accelerations))); hold on
