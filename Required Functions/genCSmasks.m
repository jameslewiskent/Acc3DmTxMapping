function [masks] = genCSmasks(sx, sy, fovx, fovy, calib, ellipse, pp, accelerations, Mask_N,num_samples_per_acc)
...
%sx = 24; sy = 24; fovx = 250; fovy = 250; calib = 4; ellipse = 0; pp = 0; accelerations = 0; Mask_N = 10; num_samples_per_acc = 156;
